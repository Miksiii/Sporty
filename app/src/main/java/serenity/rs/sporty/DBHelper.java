...
public class DBHelper extends SQLiteOpenHelper
{
    ...
    public User getUserWithCredentials(String username)
    {
        ...
        try
        {
            cursor = db.rawQuery("SELECT * FROM "+DB_TABLE_USERS+" where username='"+username+"'" , null);
    ...
    public User getUserWithCredentials(String username, String password)
    {
        ...
        try
        {
            cursor = db.rawQuery("SELECT * FROM "+DB_TABLE_USERS+" where username='"+username+"' and password='"+password+"'" , null);
    ...
    public ArrayList<Event> getListOfEventsCreatedBy(String username, String sportType)
    {
        ...
        Cursor cursor = db.rawQuery("SELECT * FROM "+DB_TABLE_EVENTS+" where users_username='"+username+"' and sports_type='"+sportType+"'" , null);
    ...
    public boolean updateUser(int id, String username, String password, String link)
    {
        ...
        // Update user instance so we can access relevant data on each activity
    ...
    public boolean updateEvent(int id, int peopleGoing)
    {
        ContentValues eventContent = new ContentValues();
        eventContent.put(EVENTS_JOINED_PEOPLE, peopleGoing);
